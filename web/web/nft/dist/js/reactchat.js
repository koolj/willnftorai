! function(t, e) {
    ...
    return function(t) {
        ...
        */
        ...
        (t.exports = n(10)(!1)).push([t.i, ".conversation-container .sender{align-items:center;visibility: show;display:flex;background-color:#f4f7f9;height:45px;padding:5px}.conversation-container .new-message{font-size:.9em;width:100%;border:0;background-color:#f4f7f9;height:30px;padding-left:5px}.conversation-container .new-message:focus{outline:none}.conversation-container .send{background:#f4f7f9;border:0}.conversation-container .send .send-icon{height:25px}@media screen and (max-width:800px){.conversation-container .sender{border-radius:0;flex-shrink:0}}.widget-embedded .sender{flex:0,0,auto;height:60px}", ""])
    }, function(t, e, n) {
        var r = n(182);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .replies{margin:10px;display:flex;flex-wrap:wrap;overflow:auto;font-size:14px;font-family:Roboto,serif}.conversation-container .reply{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-flex-align:center;-ms-flex-align:center;-webkit-align-items:center;align-items:center;border:1px solid #0084ff;border-radius:15px;color:#0084ff;padding:4px 8px;max-width:215px;min-height:1.7em;text-align:center;font-family:Roboto,serif;cursor:pointer;margin:.25em}.conversation-container .response{background-color:rgba(255, 255, 255, 0.7);color:#000;border-radius:10px;padding:15px;max-width:515px;text-align:left;font-family:Roboto,serif}.conversation-container .avatar{width:40px;height:40px;border-radius:100%;margin-right:10px}", ""])
    }, function(t, e, n) {
        var r = n(188);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .message{margin:10px;display:flex;font-size:14px;font-family:Roboto,serif}.conversation-container .message .markdown p{margin:0}.conversation-container .client{background-color:;color:#fff;border-radius:10px;padding:15px;max-width:515px;text-align:left;font-family:Roboto,serif;margin-left:auto;overflow-wrap:break-word}.conversation-container .client a{color:#35cce6}.conversation-container .response{background-color:rgba(255, 255, 255, 0.7);color:#000;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;overflow-wrap:break-word}.conversation-container .message-text{margin:0}.conversation-container .avatar{width:40px;height:40px;border-radius:100%;margin-right:10px}", ""])
    }, function(t, e, n) {
        var r = n(194);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .header{background-color:rgba(255, 255, 255, 0.7);color:#fff;display:flex;flex-direction:column;justify-content:center;text-align:center;height:75px;font-family:Roboto,serif}.conversation-container .title{font-size:20px;margin:0;font-family:Roboto,serif;color:rgba(255, 116, 0, 0.5)}.conversation-container .close-button{display:none}.conversation-container .audioarea{position: absolute;left: 40px; top: 20px;padding-left: 5px;left: 0px; width:35px; height:35px;;z-index:5002}.conversation-container .send-icon2{position: absolute;left: 40px; top: 20px;padding-left: 5px;left: 0px; width:35px; height:35px;;z-index:5000}.conversation-container .send-icon3{position: absolute;left: 40px; top: 20px;padding-left: 5px; left: 0px;width:35px; height:35px;z-index:5001}.conversation-container .loading{background-color:#b5b5b5;color:#fff;display:flex;flex-direction:column;text-align:center;padding:5px 0;font-family:Roboto,serif;font-size:14px}.widget-embedded .header{display:none}.full-screen .header{border-radius:0;flex-shrink:0;position:relative}.full-screen .close-button{display:flex;justify-content:center;align-items:center;background-color:#ff7400;border:0;position:absolute;right:10px;width:40px}.full-screen .close{width:30px;height:30px}.full-screen .close.default{width:20px;height:20px}.full-screen .loading{border-radius:0;flex-shrink:0;position:relative}@media screen and (max-width:800px){.conversation-container .header{border-radius:0;flex-shrink:0;position:relative}.conversation-container .close-button{display:flex;justify-content:center;align-items:center;background-color:#ff7400;border:0;position:absolute;right:10px;width:40px}.conversation-container .close{width:30px;height:30px}.conversation-container .close.default{width:20px;height:20px}.conversation-container .loading{border-radius:0;flex-shrink:0;position:relative}}", ""])
    }, function(t, e, n) {
        var r = n(288);
        "string" == typeof r && (r = [
            [t.i, r, ""]
