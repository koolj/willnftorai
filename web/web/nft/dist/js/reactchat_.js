! function(t, e) {
    ...
    return function(t) {
        ...
        */
        ...
        (t.exports = n(10)(!1)).push([t.i, ".conversation-container .sender{align-items:center;display:flex;background-color:#f4f7f9;height:45px;padding:5px}.conversation-container .new-message{font-size:.9em;width:100%;border:0;background-color:#f4f7f9;height:30px;padding-left:5px}.conversation-container .new-message:focus{outline:none}.conversation-container .send{background:#f4f7f9;border:0}.conversation-container .send .send-icon{height:25px}@media screen and (max-width:800px){.conversation-container .sender{border-radius:0;flex-shrink:0}}.widget-embedded .sender{flex:0,0,auto;height:60px}", ""])
    }, function(t, e, n) {
        var r = n(182);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .message{margin:10px;display:flex;font-size:14px;font-family:Roboto,serif}.conversation-container .message .markdown p{margin:0}.conversation-container .client{background-color:#17a2b8;color:#fff;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;margin-left:auto;overflow-wrap:break-word}.conversation-container .client a{color:#35cce6}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:10px;padding:15px;max-width:215px;text-align:left;font-family:Roboto,serif;overflow-wrap:break-word}.conversation-container .message-text{margin:0}.conversation-container .avatar{width:40px;height:40px;border-radius:100%;margin-right:10px}", ""])
    }, function(t, e, n) {
        var r = n(194);
        "string" == typeof r && (r = [
            [t.i, r, ""]
        ...
        (e = t.exports = n(10)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".conversation-container .header{background-color:#17a2b8;color:#fff;display:flex;flex-direction:column;justify-content:center;text-align:center;height:75px;font-family:Roboto,serif}.conversation-container .title{font-size:20px;margin:0;font-family:Roboto,serif}.conversation-container .close-button{display:none}.conversation-container .audioarea{position: absolute;left: 40px; top: 20px;padding-left: 5px;left: 0px; width:35px; height:35px;;z-index:5002}.conversation-container .send-icon2{position: absolute;left: 40px; top: 20px;padding-left: 5px;left: 0px; width:35px; height:35px;;z-index:5000}.conversation-container .send-icon3{position: absolute;left: 40px; top: 20px;padding-left: 5px; left: 0px;width:35px; height:35px;z-index:5001}.conversation-container .loading{background-color:#b5b5b5;color:#fff;display:flex;flex-direction:column;text-align:center;padding:5px 0;font-family:Roboto,serif;font-size:14px}.widget-embedded .header{display:none}.full-screen .header{border-radius:0;flex-shrink:0;position:relative}.full-screen .close-button{display:flex;justify-content:center;align-items:center;background-color:#17a2b8;border:0;position:absolute;right:10px;width:40px}.full-screen .close{width:30px;height:30px}.full-screen .close.default{width:20px;height:20px}.full-screen .loading{border-radius:0;flex-shrink:0;position:relative}@media screen and (max-width:800px){.conversation-container .header{border-radius:0;flex-shrink:0;position:relative}.conversation-container .close-button{display:flex;justify-content:center;align-items:center;background-color:#17a2b8;border:0;position:absolute;right:10px;width:40px}.conversation-container .close{width:30px;height:30px}.conversation-container .close.default{width:20px;height:20px}.conversation-container .loading{border-radius:0;flex-shrink:0;position:relative}}", ""])
    }, function(t, e, n) {
        var r = n(288);
        "string" == typeof r && (r = [
            [t.i, r, ""]
            ...
            function e(t) {
                ...
                return n.trySendInitPayload = function() {
					...
					function initWebSocket(sampleRate) {
						...
						result = '';
                        //result = $("#rectext").html();
                        //wss://asr2.openfpt.vn/ws?content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)44100,+format=(string)S16LE,+channels=(int)1
                        //wss://demo-stream.fpt.ai/ws?content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)44100,+format=(string)S16LE,+channels=(int)1
                        
                        ws = new WebSocket("wss://demo-stream.openfpt.vn/ws?content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)" + sampleRate + ",+format=(string)S16LE,+channels=(int)1");
                        console.log(ws);
						ws.onopen = function () {
							...
							if (resp.status == 0 && resp.result && resp.result.hypotheses.length > 0) {
								...
								if ((resp.result.final) && (text != ''))  {
									...
									//$("#mess").text(result);
										...
										//send message
										//t.preventDefault();
										console.log("=======>>> OUTGOING_REC__"+ result);
										e = result;
